<template>
  <div class="row">
    <div class="col-12 col-sm-6 col-md-4 pa-8">
      <q-input
        v-model="(data.components[j].props as ShortsComponent).url"
        label="Ссылка на видео"
        color="panel-primary"
        hint="Выберите видео на YouTube Shorts, нажмите встроить и скопируйте ссылку из тега src"
...
import { type ShortsComponent } from '~/components/admin/widgets/component/AddPageComponent/types'

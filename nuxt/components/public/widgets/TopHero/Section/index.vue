<template>
  <div
    ...
    :style="video ? `background: none;` : ''"
  >
    <div
      v-if="video"
      class="top-hero-section_container__video"
    >
      <video
        :poster="'/images/modal_bg.jpg'"
        autoplay
        muted
        loop
    ...
    <div class="top-hero-section_container__left_container_hero_info">
      ...
      <div class="top-hero-section_container__left_container__btns">
        <button @click="showTopHeroModal = true">
          Подробнее
        </button>
  ...
  <PublicWidgetsCommonFormModalTopHero v-model:show-modal="showTopHeroModal" />
</template>
...
defineProps<Props>()
const showTopHeroModal = ref(false)
</script>
  ...
  &__video {
    ...
    video {
      @include more-than-small-mobile {
        ...
        -webkit-filter: brightness(30%) blur(4px);
